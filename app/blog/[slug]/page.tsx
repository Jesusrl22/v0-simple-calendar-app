...
const blogContent = {
  "second-brain": {
    en: {
      ...
      intro: "Have you ever felt like you have too many ideas, tasks, and projects floating in your head? The 'Second Brain' concept can change everything.",
      content: [
        {
          type: "text",
        ...
        {
          type: "heading",
          text: "Why Modern Task Apps are Essential",
        },
        {
          type: "text",
    ...
    es: {
      ...
      image: "/blog-covers/second-brain.jpg",
      intro: "¿Alguna vez has sentido que tienes demasiadas ideas, tareas y proyectos flotando en tu cabeza? El concepto del 'Segundo Cerebro' puede cambiarlo todo.",
      content: [
        {
          type: "text",
          text: "El concepto del Segundo Cerebro, popularizado por Tiago Forte en su libro 'Building a Second Brain', se basa en una idea simple pero poderosa: tu mente no está diseñada para almacenar información, sino para procesarla y crear con ella. Cuando intentamos recordar todo —fechas, ideas, tareas, proyectos, nombres— saturamos nuestra memoria de trabajo y perdemos capacidad cognitiva para lo que realmente importa: pensar, crear y decidir.",
        },
        {
          type: "heading",
          text: "¿Qué es el Segundo Cerebro?",
        },
        {
          type: "text",
          text: "Un Segundo Cerebro es un sistema externo de organización personal que captura todo lo que tu mente no debería tener que retener. No es solo una lista de tareas; es un ecosistema completo donde fluyen tus ideas, proyectos, referencias y objetivos de vida.",
        },
        {
          type: "heading",
          text: "Los 4 Pilares (Método CODE)",
        },
        {
          type: "list",
          items: [
            "Capturar — Recoge todo lo que te resulta valioso: ideas, artículos, notas de reuniones, citas inspiradoras. No filtres en este paso.",
            "Organizar — Clasifica lo capturado según proyectos activos, áreas de responsabilidad, recursos y archivo (sistema PARA)",
            "Destilar — Extrae la esencia de cada nota. ¿Cuál es el punto más importante? Resalta, resume, sintetiza.",
            "Expresar — Usa ese conocimiento acumulado para crear: presentaciones, proyectos, artículos, decisiones",
          ],
        },
        {
          type: "heading",
          text: "Por Qué las Apps Modernas son Esenciales",
        },
        {
          type: "text",
          text: "Una app de gestión de tareas moderna no es solo una lista de pendientes. Es el núcleo operativo de tu Segundo Cerebro donde tus capturas se convierten en acciones concretas, donde tus proyectos cobran vida. Las mejores aplicaciones combinan calendario integrado, etiquetas, prioridades, asistente de IA, colaboración en equipo y seguimiento de hábitos todo en un lugar.",
        },
      ],
    },
    fr: {
      ...
      image: "/blog-covers/second-brain.jpg",
      intro: "Avez-vous jamais senti que vous aviez trop d'idées, de tâches et de projets qui flottent dans votre tête? Le concept du 'Deuxième Cerveau' peut tout changer.",
      content: [
        {
          type: "text",
          text: "Le concept d'un 'deuxième cerveau', popularisé par Tiago Forte dans son livre 'Building a Second Brain', est basé sur une idée simple mais puissante: votre esprit n'est pas conçu pour stocker des informations, mais pour les traiter et créer avec elles.",
        },
        {
          type: "heading",
        ...
        {
          type: "text",
          text: "Un deuxième cerveau est un système externe d'organisation personnelle qui capture tout ce que votre esprit ne devrait pas avoir à retenir. Ce n'est pas seulement une liste de tâches; c'est un écosystème complet où vos idées, projets, références et objectifs de vie s'écoulent ensemble.",
        },
        {
          type: "heading",
          text: "Les 4 Piliers (Méthode CODE)",
        },
        {
          type: "list",
          items: [
            "Capturer — Collectez tout ce qui est précieux: idées, articles, notes de réunion, citations inspirantes",
            "Organiser — Classez ce que vous avez capturé par projets actifs, domaines de responsabilité et archives (système PARA)",
            "Distiller — Extrayez l'essence de chaque note. Quel est le point le plus important?",
            "Exprimer — Utilisez les connaissances accumulées pour créer: présentations, projets, articles",
          ],
        },
      ],
    },
    de: {
      ...
      image: "/blog-covers/second-brain.jpg",
      intro: "Haben Sie jemals das Gefühl gehabt, dass Sie zu viele Ideen, Aufgaben und Projekte in Ihrem Kopf haben? Das Konzept des 'Zweiten Gehirns' kann alles verändern.",
      content: [
        {
          type: "text",
          text: "Das Konzept eines 'zweiten Gehirns', popularisiert von Tiago Forte in seinem Buch 'Building a Second Brain', basiert auf einer einfachen aber kraftvollen Idee: Ihr Verstand ist nicht dazu bestimmt, Informationen zu speichern, sondern sie zu verarbeiten und damit zu schaffen.",
        },
        {
          type: "heading",
        ...
        {
          type: "text",
          text: "Ein zweites Gehirn ist ein externes Organisationssystem, das alles erfasst, was Ihr Verstand nicht behalten sollte. Es ist nicht nur eine Aufgabenliste; es ist ein vollständiges Ökosystem, in dem Ihre Ideen, Projekte, Referenzen und Lebensziele zusammenfließen.",
        },
      ],
    },
    it: {
      ...
      image: "/blog-covers/second-brain.jpg",
      intro: "Hai mai sentito di avere troppe idee, compiti e progetti nella tua testa? Il concetto del 'Secondo Cervello' può cambiare tutto.",
      content: [
        {
          type: "text",
          text: "Il concetto di un 'secondo cervello', reso popolare da Tiago Forte nel suo libro 'Building a Second Brain', si basa su un'idea semplice ma potente: la tua mente non è progettata per immagazzinare informazioni, ma per elaborarle e creare con esse.",
        },
        {
          type: "heading",
        ...
        {
          type: "text",
          text: "Un secondo cervello è un sistema esterno di organizzazione personale che cattura tutto ciò che la tua mente non dovrebbe dover ricordare. Non è solo una lista di cose da fare; è un ecosistema completo dove le tue idee, progetti, riferimenti e obiettivi di vita convergono.",
        },
      ],
    },
  },
  "habit-formation": {
    en: {
      ...
      readTime: "9 min read",
      category: "Habits & Science",
      image: "/blog-covers/habit-formation.jpg",
      intro: "Everyone's heard it takes 21 days to form a habit. It's completely false. Recent research shows the truth is far more complex and individualized.",
      content: [
        {
          type: "heading",
          text: "The Origin of the 21-Day Myth",
        },
        {
          type: "text",
        ...
        {
          type: "heading",
          text: "What Real Scientific Research Shows",
        },
        {
          type: "text",
    ...
    es: {
      ...
      category: "Hábitos y Ciencia",
      image: "/blog-covers/habit-formation.jpg",
      intro: "Todos hemos escuchado que se necesitan 21 días para formar un hábito. Es completamente falso. La investigación reciente muestra que la verdad es mucho más compleja.",
      content: [
        {
          type: "heading",
          text: "El Origen del Mito de 21 Días",
        },
        {
          type: "text",
          text: "La cifra de 21 días proviene de una observación del cirujano plástico Maxwell Maltz en los años 60. Maltz notó que sus pacientes tardaban aproximadamente 21 días en acostumbrarse a su nueva apariencia tras una operación. El problema es que esta observación clínica, basada en un mínimo estimado para un tipo muy específico de adaptación psicológica, se transformó en un dogma popular de autoayuda. Millones de personas creen que si aguantan 21 días haciendo algo, el hábito quedará instalado para siempre. Cuando fallan en el día 22, concluyen que son incapaces de cambiar.",
        },
        {
          type: "heading",
          text: "Lo Que Dice la Investigación Científica Real",
        },
        {
          type: "text",
          text: "El estudio más riguroso fue publicado en 2010 por Phillippa Lally en el University College London. Siguieron a 96 participantes durante 12 semanas mientras intentaban instaurar nuevos hábitos cotidianos. Los resultados fueron reveladores: el tiempo necesario oscilaba entre 18 y 254 días, con una media de 66 días. Los hábitos más complejos tardaban considerablemente más. Otro hallazgo crucial: saltarse un día no arruinaba el proceso. La consistencia a largo plazo importa mucho más que la perfección a corto plazo.",
        },
        {
          type: "heading",
          text: "El Bucle del Hábito: Cómo Funciona Realmente Tu Cerebro",
        },
        {
          type: "text",
          text: "Charles Duhigg describió la estructura neurológica como un bucle de tres elementos: Señal (disparador), Rutina (comportamiento), y Recompensa (beneficio). Con el tiempo, la señal y la recompensa se fusionan de tal manera que el comportamiento se vuelve automático, ejecutándose sin apenas esfuerzo consciente. A esto se le llama 'chunking'.",
        },
      ],
    },
    fr: {
      ...
      category: "Habitudes et Science",
      image: "/blog-covers/habit-formation.jpg",
      intro: "Tout le monde a entendu dire qu'il faut 21 jours pour former une habitude. C'est complètement faux. La recherche récente montre que la vérité est bien plus complexe.",
      content: [
        {
          type: "heading",
          text: "L'Origine du Mythe des 21 Jours",
        },
        {
          type: "text",
          text: "Le chiffre de 21 jours provient d'une observation des années 1960 du chirurgien plasticien Maxwell Maltz. Maltz a remarqué que ses patients mettaient environ 21 jours à s'habituer à leur nouvelle apparence après une opération.",
        },
        {
          type: "heading",
          text: "Ce Que Dit la Recherche Scientifique Réelle",
        },
        {
          type: "text",
          text: "L'étude la plus rigoureuse a été publiée en 2010 par Phillippa Lally à l'University College London. Ils ont suivi 96 participants pendant 12 semaines. Les résultats ont été révélateurs: le temps nécessaire pour que un comportement devienne automatique oscillait entre 18 et 254 jours, avec une moyenne de 66 jours.",
        },
      ],
    },
    de: {
      ...
      category: "Gewohnheiten und Wissenschaft",
      image: "/blog-covers/habit-formation.jpg",
      intro: "Jeder hat gehört, dass es 21 Tage dauert, eine Gewohnheit zu bilden. Das ist völlig falsch. Die aktuelle Forschung zeigt, dass die Wahrheit viel komplexer ist.",
      content: [
        {
          type: "heading",
          text: "Der Ursprung des 21-Tage-Mythos",
        },
        {
          type: "text",
          text: "Die Zahl 21 stammt aus einer Beobachtung des plastischen Chirurgen Maxwell Maltz aus den 1960er Jahren. Maltz bemerkte, dass seine Patienten etwa 21 Tage brauchten, um sich an ihr neues Aussehen nach einer Operation zu gewöhnen.",
        },
        {
          type: "heading",
          text: "Was die echte wissenschaftliche Forschung zeigt",
        },
        {
          type: "text",
          text: "Die rigoroseste Studie wurde 2010 von Phillippa Lally am University College London veröffentlicht. Sie verfolgten 96 Teilnehmer über 12 Wochen. Die Ergebnisse waren aufschlussreich: Die Zeit bis zur Automatisierung reichte von 18 bis 254 Tagen, mit einem Durchschnitt von 66 Tagen.",
        },
      ],
    },
    it: {
      ...
      category: "Abitudini e Scienza",
      image: "/blog-covers/habit-formation.jpg",
      intro: "Tutti hanno sentito dire che ci vogliono 21 giorni per formare un'abitudine. È completamente falso. La ricerca recente mostra che la verità è molto più complessa.",
      content: [
        {
          type: "heading",
          text: "L'Origine del Mito dei 21 Giorni",
        },
        {
          type: "text",
          text: "La cifra di 21 giorni proviene da un'osservazione degli anni '60 del chirurgo plastico Maxwell Maltz. Maltz notò che i suoi pazienti impiegavano circa 21 giorni per abituarsi al loro nuovo aspetto dopo un intervento.",
        },
        {
          type: "heading",
          text: "Cosa Dice la Vera Ricerca Scientifica",
        },
        {
          type: "text",
          text: "Lo studio più rigoroso è stato pubblicato nel 2010 da Phillippa Lally all'University College London. Hanno seguito 96 partecipanti per 12 settimane. I risultati sono stati rivelatori: il tempo necessario per l'automatizzazione variava da 18 a 254 giorni, con una media di 66 giorni.",
        },
      ],
    },
  },
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            "Traccia ciò che fai in ogni pomodoro. Vedere quelle spuntature �� addittivo",
