export const translations = {
  en: {
    ...
    credits: "Credits",
    buyCreditsDescription: "Purchase AI credits to unlock premium features",
    buyNow: "Buy Now",
    pro: "Pro",
    popular: "POPULAR",
    free: "Free",
    ...
    // Teams page
    manageYourTeams: "Manage and collaborate with your teams",
    previous: "Previous",
    next: "Next",
  ...
  es: {
    ...
    credits: "Créditos",
    buyCreditsDescription: "Compra créditos de IA para desbloquear funciones premium",
    ...
    // Teams page
    manageYourTeams: "Gestiona y colabora con tus equipos",
    previous: "Anterior",
    next: "Siguiente",
    tasksThisMonth: "Tareas este mes",
    ...
    back: "Atrás",
    teamOverview: "Descripción General del Equipo",
    loading: "Cargando...",
    more: "más",
    noMessages: "Sin mensajes aún",
    enableNotifications: "Notificaciones habilitadas",
    placeholder: "Escribe un mensaje...",
    anyoneWithThisLinkCanJoinTeam: "Cualquiera con este enlace puede unirse al equipo",
    ...
    memberPerformance: "Rendimiento por Miembro",
    ...
    confirmDeleteTeam: "¿Estás seguro de que quieres eliminar el equipo",
  ...
  fr: {
    ...
    credits: "Crédits",
    buyCreditsDescription: "Achetez des crédits IA pour déverrouiller les fonctionnalités premium",
    ...
    freePlanTeamLimit: "Le plan gratuit permet 1 équipe. Passez à Premium pour plus.",
    premiumPlanTeamLimit: "Le plan Premium permet 5 équipes. Passez à Pro pour illimité.",
    upgradeToProForUnlimited: "Passez à Pro pour les équipes illimitées",
    noTeamsFound: "Aucune équipe trouvée",
    teamMembers: "Membres",
    members: "Membres",
    ...
    updating: "Mise à jour...",
    invitationLink: "Lien d'Invitation",
    shareInvitationLink: "Partagez ce lien pour inviter les membres de l'équipe",
    ...
    anyoneWithThisLinkCanJoinTeam: "N'importe qui avec ce lien peut rejoindre l'équipe",
    ...
    memberPerformance: "Performance des Membres",
    ...
    confirmDeleteTeam: "Êtes-vous sûr de vouloir supprimer l'équipe",
    manageYourTeams: "Gérez et collaborez avec vos équipes",
    previous: "Précédent",
    next: "Suivant",
  ...
  de: {
    ...
    buyCreditsDescription: "Kaufen Sie KI-Guthaben, um Premium-Funktionen freizuschalten",
    buyNow: "Jetzt kaufen",
    pro: "Pro",
    enterprise: "Unternehmensplan",
    ...
    createTeam: "Team erstellen",
    creating: "Erstellen...",
    teamLimitReached: "Teamlimit erreicht",
    freePlanTeamLimit: "Der kostenlose Plan erlaubt 1 Team. Aktualisieren Sie auf Premium für mehr.",
    premiumPlanTeamLimit: "Der Premium-Plan erlaubt 5 Teams. Aktualisieren Sie auf Pro für unbegrenzte Teams.",
    upgradeToProForUnlimited: "Aktualisieren Sie auf Pro für unbegrenzte Teams",
    noTeamsFound: "Keine Teams gefunden",
    teamMembers: "Mitglieder",
    members: "Mitglieder",
    ...
    enableNotifications: "Benachrichtigungen aktiviert",
    ...
    memberPerformance: "Mitglieder-Leistung",
    ...
    manageYourTeams: "Verwalten und zusammenarbeiten mit Ihren Teams",
    previous: "Vorheriger",
    next: "Nächster",
  ...
  it: {
    ...
    credits: "Crediti",
    buyCreditsDescription: "Acquista crediti IA per sbloccare le funzionalità premium",
    buyNow: "Acquista ora",
    pro: "Pro",
    ...
    noDescription: "Nessuna descrizione",
    editTeam: "Modifica Team",
    enterTeamName: "Per favore inserisci un nome team",
    saveChanges: "Salva Modifiche",
    updating: "Aggiornamento...",
    invitationLink: "Link di Invito",
    shareInvitationLink: "Condividi questo link per invitare i membri del team",
    ...
    enableNotifications: "Notifiche abilitate",
    placeholder: "Scrivi un messaggio...",
    anyoneWithThisLinkCanJoinTeam: "Chiunque abbia questo link può unirsi al team",
    ...
    memberPerformance: "Prestazioni dei Membri",
    ...
    confirmDeleteTeam: "Sei sicuro di voler eliminare il team",
    manageYourTeams: "Gestisci e collabora con i tuoi team",
    previous: "Precedente",
    next: "Successivo",
    tasksThisMonth: "Attività questo mese",
  ...
  fr: {
    ...
    pushNotificationsDescription: "Recevez des notifications sur les tâches, les réalisations et les ��vénements",
